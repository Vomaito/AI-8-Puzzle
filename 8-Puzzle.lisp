...
(DEFUN HEURISTICA(NODO)
  ...
  (LOOP
    ...
    (SETQ
      ...
      INIY (REM (ELEMENT_AT INDEX NODO) 3)
      FINX (MOD (ELEMENT_AT INDEX SOLUCION) 3)
      FINY (REM (ELEMENT_AT INDEX SOLUCION) 3)
    )
    (SETQ
...
(DEFUN EXPANDIR(OPTION)
  ...
  (((NEQ UP NIL)
      (PUSH (LIST UP (+ 1 (SECOND OPTION)) (HEURISTICA UP) 'U' (SIXTH OPTION) (SIXTH OPTION)) LSTNEXT )
  ))
  (((NEQ DOWN NIL)
...
(DEFUN ISINCLOSEDSTACK (NODO)
  (SETQ INDEX 0)
  (LOOP
    ((NILL CAR(NTH INDEX CLOSEDSTACK)) T)
...
(DEFUN BACKTRACK (NODO)
  ...
  (LOOP
    ...
    (((EQUAL IDFATHER (SIXTH BUSQOPTION))
      (SETQ
